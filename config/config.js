...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.insight-xp');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\XP\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/XP/';
  if (isLinux) dataDir = process.env.HOME + '/.XP/';
}
